...
type MethodSettings_LongRunning struct {
	...
	MaxPollDelay *duration.Duration `protobuf:"bytes,3,opt,name=max_poll_delay,json=maxPollDelay,proto3" json:"max_poll_delay,omitempty"`
...
func (x *MethodSettings_LongRunning) GetInitialPollDelay() *duration.Duration {
	if x != nil {
...
func (x *MethodSettings_LongRunning) GetMaxPollDelay() *duration.Duration {
	if x != nil {
...
func (x *MethodSettings_LongRunning) GetTotalPollTimeout() *duration.Duration {
	if x != nil {
...
var file_google_api_client_proto_goTypes = []any{
	...
	(*descriptor.ServiceOptions)(nil),  // 22: google.protobuf.ServiceOptions
}
...
func file_google_api_client_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_api_client_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_google_api_client_proto_msgTypes[16].Exporter = func(v any, i int) any {
