...
func file_google_api_system_parameter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_api_system_parameter_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_api_system_parameter_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_api_system_parameter_proto_msgTypes[2].Exporter = func(v any, i int) any {
