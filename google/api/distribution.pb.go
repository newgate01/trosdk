...
type Distribution_Exemplar struct {
	...
	Attachments []*any1.Any `protobuf:"bytes,3,rep,name=attachments,proto3" json:"attachments,omitempty"`
}
...
func (x *Distribution_Exemplar) GetAttachments() []*any1.Any {
	if x != nil {
...
func file_google_api_distribution_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_api_distribution_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_api_distribution_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_api_distribution_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_api_distribution_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_api_distribution_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_api_distribution_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_api_distribution_proto_msgTypes[6].Exporter = func(v any, i int) any {
