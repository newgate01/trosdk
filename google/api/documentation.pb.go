...
func file_google_api_documentation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_api_documentation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_api_documentation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_api_documentation_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Page); i {
			case 0:
				return &v.state
			case 1:
